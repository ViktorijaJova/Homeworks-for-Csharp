    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Car firstCar = Methods.ChoseCarWithDriver(CarArray, DriverArray);
                Car secondCar = Methods.ChoseCarWithDriver(CarArray, DriverArray);

                Methods.RaceCars(firstCar, secondCar);

                Console.WriteLine("Do you want to chek another one Y/N ");
                RunProgram = Methods.RunAgain();
